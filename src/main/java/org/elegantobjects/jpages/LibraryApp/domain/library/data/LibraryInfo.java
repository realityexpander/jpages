        ...
        Model.ToDomainInfo<LibraryInfo>
{
    ...
    public Result<UUID2<Book>> removeTransferringBookFromInventory(@NotNull Book transferringBook) {
        return removeBookIdFromInventory(transferringBook.id(), 1);
    }

    public Result<UUID2<Book>> addTransferringBookToInventory(@NotNull Book transferringBook) {
