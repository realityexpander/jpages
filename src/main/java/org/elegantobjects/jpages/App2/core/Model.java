...
public class Model {
    ...
    public interface ToDomainInfo<TDomainInfo extends Domain> {
        ...
        interface hasToDeepCopyDomainInfo<TToInfo extends Model.ToDomainInfo<? extends Domain>> {
    ...
    protected interface ToEntity<T extends Entity> {
        T toEntity(); // Should return a deep copy (no original references)
    }
    protected interface ToDTO<T extends DTO> {
